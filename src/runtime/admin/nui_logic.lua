...
--- Handles admin NUI RPC requests and emits standardized result payload.
--- @param src number Player source that initiated the RPC call.
--- @param requestId string|number Client-side correlation id.
--- @param data table|nil RPC request payload.
--- @return nil
local function onNuiAdminRpc(src, requestId, data)
