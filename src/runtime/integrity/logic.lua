...
--- Handles server integrity run requests from the client/admin UI.
--- @param src number Player source that triggered the request.
...
--- Handles client progress-bar result callback after integrity run.
--- @param src number Player source that reported progress result.
--- @param success boolean True when progress finished, false on cancel/error.
--- @return nil
local function onIntegrityProgressResult(src, success)
...
return {
    onIntegrityRequest = onIntegrityRequest,
    onIntegrityProgressResult = onIntegrityProgressResult,
}
